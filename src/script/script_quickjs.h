...
namespace qjs
{
    ...
    struct js_traits<Proxy>
    {
        static JSValue wrap(JSContext *ctx, const Proxy &n) noexcept
        {
            ...
            JS_DefinePropertyValueStr(ctx, obj, "TLSPubkeySha256", JS_NewString(ctx, n.TLSPubkeySha256), JS_PROP_C_W_E);
            ...
            JS_DefinePropertyValueStr(ctx, obj, "AmneziaVersion", JS_NewString(ctx, n.AmneziaVersion), JS_PROP_C_W_E);
            JS_DefinePropertyValueStr(ctx, obj, "AmneziaHeaderProtectionKey", JS_NewString(ctx, n.AmneziaHeaderProtectionKey), JS_PROP_C_W_E);
            JS_DefinePropertyValueStr(ctx, obj, "AmneziaContentPaddingAddition", JS_NewString(ctx, n.AmneziaContentPaddingAddition), JS_PROP_C_W_E);
            JS_DefinePropertyValueStr(ctx, obj, "AmneziaRekeyAfterTime", JS_NewString(ctx, n.AmneziaRekeyAfterTime), JS_PROP_C_W_E);
            JS_DefinePropertyValueStr(ctx, obj, "AmneziaRekeyTimeout", JS_NewString(ctx, n.AmneziaRekeyTimeout), JS_PROP_C_W_E);
            JS_DefinePropertyValueStr(ctx, obj, "AmneziaRejectAfterTime", JS_NewString(ctx, n.AmneziaRejectAfterTime), JS_PROP_C_W_E);
            JS_DefinePropertyValueStr(ctx, obj, "AmneziaKeepaliveTimeout", JS_NewString(ctx, n.AmneziaKeepaliveTimeout), JS_PROP_C_W_E);
            JS_DefinePropertyValueStr(ctx, obj, "AmneziaMaxHandshakeAttempts", JS_NewString(ctx, n.AmneziaMaxHandshakeAttempts), JS_PROP_C_W_E);
            ...
            JS_DefinePropertyValueStr(ctx, obj, "OpenVPNDataCiphers", js_traits<StringArray>::wrap(ctx, n.OpenVPNDataCiphers), JS_PROP_C_W_E);
            JS_DefinePropertyValueStr(ctx, obj, "OpenVPNDataCipherFallback", JS_NewString(ctx, n.OpenVPNDataCipherFallback), JS_PROP_C_W_E);
            JS_DefinePropertyValueStr(ctx, obj, "OpenVPNTLSCrypt", JS_NewString(ctx, n.OpenVPNTLSCrypt), JS_PROP_C_W_E);
            JS_DefinePropertyValueStr(ctx, obj, "OpenVPNTLSCryptV2", JS_NewString(ctx, n.OpenVPNTLSCryptV2), JS_PROP_C_W_E);
            ...
            // SSH
            JS_DefinePropertyValueStr(ctx, obj, "SSHPrivateKey", JS_NewString(ctx, n.SSHPrivateKey), JS_PROP_C_W_E);
            JS_DefinePropertyValueStr(ctx, obj, "SSHPrivateKeyPassphrase", JS_NewString(ctx, n.SSHPrivateKeyPassphrase), JS_PROP_C_W_E);
            JS_DefinePropertyValueStr(ctx, obj, "SSHHostKey", js_traits<StringArray>::wrap(ctx, n.SSHHostKey), JS_PROP_C_W_E);
            JS_DefinePropertyValueStr(ctx, obj, "SSHHostKeyAlgorithms", js_traits<StringArray>::wrap(ctx, n.SSHHostKeyAlgorithms), JS_PROP_C_W_E);
            ...
            // ZeroTier
            JS_DefinePropertyValueStr(ctx, obj, "ZeroTierNetwork", JS_NewString(ctx, n.ZeroTierNetwork), JS_PROP_C_W_E);
            JS_DefinePropertyValueStr(ctx, obj, "ZeroTierStateDir", JS_NewString(ctx, n.ZeroTierStateDir), JS_PROP_C_W_E);
            JS_DefinePropertyValueStr(ctx, obj, "ZeroTierPlanet", JS_NewString(ctx, n.ZeroTierPlanet), JS_PROP_C_W_E);
            JS_DefinePropertyValueStr(ctx, obj, "ZeroTierPhysicalMTU", JS_NewInt32(ctx, n.ZeroTierPhysicalMTU), JS_PROP_C_W_E);
            JS_DefinePropertyValueStr(ctx, obj, "ZeroTierLowBandwidth", js_traits<tribool>::wrap(ctx, n.ZeroTierLowBandwidth), JS_PROP_C_W_E);
            JS_DefinePropertyValueStr(ctx, obj, "ZeroTierEncryptedHello", js_traits<tribool>::wrap(ctx, n.ZeroTierEncryptedHello), JS_PROP_C_W_E);
            JS_DefinePropertyValueStr(ctx, obj, "ZeroTierPrimaryPort", JS_NewInt32(ctx, n.ZeroTierPrimaryPort), JS_PROP_C_W_E);
            JS_DefinePropertyValueStr(ctx, obj, "ZeroTierSecondaryPort", JS_NewInt32(ctx, n.ZeroTierSecondaryPort), JS_PROP_C_W_E);
            JS_DefinePropertyValueStr(ctx, obj, "ZeroTierTCPFallbackMode", JS_NewString(ctx, n.ZeroTierTCPFallbackMode), JS_PROP_C_W_E);
            JS_DefinePropertyValueStr(ctx, obj, "ZeroTierTCPFallbackRelay", JS_NewString(ctx, n.ZeroTierTCPFallbackRelay), JS_PROP_C_W_E);
            JS_DefinePropertyValueStr(ctx, obj, "ZeroTierOrbit", js_traits<StringArray>::wrap(ctx, n.ZeroTierOrbit), JS_PROP_C_W_E);
            JS_DefinePropertyValueStr(ctx, obj, "ZeroTierRemoteTraceTarget", JS_NewString(ctx, n.ZeroTierRemoteTraceTarget), JS_PROP_C_W_E);
            JS_DefinePropertyValueStr(ctx, obj, "ZeroTierRemoteTraceLevel", JS_NewString(ctx, std::to_string(n.ZeroTierRemoteTraceLevel)), JS_PROP_C_W_E);
            ...
            JS_DefinePropertyValueStr(ctx, obj, "AnyTLSBlockQUIC", js_traits<tribool>::wrap(ctx, n.AnyTLSBlockQUIC), JS_PROP_C_W_E);
            JS_DefinePropertyValueStr(ctx, obj, "DisableReuse", js_traits<tribool>::wrap(ctx, n.DisableReuse), JS_PROP_C_W_E);
        ...
        static Proxy unwrap(JSContext *ctx, JSValueConst v)
        {
            ...
            node.TLSPubkeySha256 = unwrap_free<std::string>(ctx, v, "TLSPubkeySha256");
            ...
            node.AmneziaVersion = unwrap_free<std::string>(ctx, v, "AmneziaVersion");
            node.AmneziaHeaderProtectionKey = unwrap_free<std::string>(ctx, v, "AmneziaHeaderProtectionKey");
            node.AmneziaContentPaddingAddition = unwrap_free<std::string>(ctx, v, "AmneziaContentPaddingAddition");
            node.AmneziaRekeyAfterTime = unwrap_free<std::string>(ctx, v, "AmneziaRekeyAfterTime");
            node.AmneziaRekeyTimeout = unwrap_free<std::string>(ctx, v, "AmneziaRekeyTimeout");
            node.AmneziaRejectAfterTime = unwrap_free<std::string>(ctx, v, "AmneziaRejectAfterTime");
            node.AmneziaKeepaliveTimeout = unwrap_free<std::string>(ctx, v, "AmneziaKeepaliveTimeout");
            node.AmneziaMaxHandshakeAttempts = unwrap_free<std::string>(ctx, v, "AmneziaMaxHandshakeAttempts");
            ...
            node.OpenVPNDataCiphers = unwrap_free<StringArray>(ctx, v, "OpenVPNDataCiphers");
            node.OpenVPNDataCipherFallback = unwrap_free<std::string>(ctx, v, "OpenVPNDataCipherFallback");
            node.OpenVPNTLSCrypt = unwrap_free<std::string>(ctx, v, "OpenVPNTLSCrypt");
            node.OpenVPNTLSCryptV2 = unwrap_free<std::string>(ctx, v, "OpenVPNTLSCryptV2");
            ...
            // SSH
            node.SSHPrivateKey = unwrap_free<std::string>(ctx, v, "SSHPrivateKey");
            node.SSHPrivateKeyPassphrase = unwrap_free<std::string>(ctx, v, "SSHPrivateKeyPassphrase");
            node.SSHHostKey = unwrap_free<StringArray>(ctx, v, "SSHHostKey");
            node.SSHHostKeyAlgorithms = unwrap_free<StringArray>(ctx, v, "SSHHostKeyAlgorithms");
            ...
            // ZeroTier
            node.ZeroTierNetwork = unwrap_free<std::string>(ctx, v, "ZeroTierNetwork");
            node.ZeroTierStateDir = unwrap_free<std::string>(ctx, v, "ZeroTierStateDir");
            node.ZeroTierPlanet = unwrap_free<std::string>(ctx, v, "ZeroTierPlanet");
            node.ZeroTierPhysicalMTU = unwrap_free<int>(ctx, v, "ZeroTierPhysicalMTU");
            node.ZeroTierLowBandwidth = unwrap_free<tribool>(ctx, v, "ZeroTierLowBandwidth");
            node.ZeroTierEncryptedHello = unwrap_free<tribool>(ctx, v, "ZeroTierEncryptedHello");
            node.ZeroTierPrimaryPort = unwrap_free<int>(ctx, v, "ZeroTierPrimaryPort");
            node.ZeroTierSecondaryPort = unwrap_free<int>(ctx, v, "ZeroTierSecondaryPort");
            node.ZeroTierTCPFallbackMode = unwrap_free<std::string>(ctx, v, "ZeroTierTCPFallbackMode");
            node.ZeroTierTCPFallbackRelay = unwrap_free<std::string>(ctx, v, "ZeroTierTCPFallbackRelay");
            node.ZeroTierOrbit = unwrap_free<StringArray>(ctx, v, "ZeroTierOrbit");
            node.ZeroTierRemoteTraceTarget = unwrap_free<std::string>(ctx, v, "ZeroTierRemoteTraceTarget");
            {
                auto trace_level = JS_GetPropertyStr(ctx, v, "ZeroTierRemoteTraceLevel");
                uint64_t out = 0;
                if(!JS_IsUndefined(trace_level) && !JS_IsNull(trace_level) && JS_ToIndex(ctx, &out, trace_level) >= 0)
                    node.ZeroTierRemoteTraceLevel = out;
                JS_FreeValue(ctx, trace_level);
            }
            ...
            node.AnyTLSBlockQUIC = unwrap_free<tribool>(ctx, v, "AnyTLSBlockQUIC");
            node.DisableReuse = unwrap_free<tribool>(ctx, v, "DisableReuse");
