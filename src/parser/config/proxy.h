...
struct Proxy
{
    ...
    tribool XHTTPDownloadNoGRPCHeader;
    String XHTTPDownloadXPaddingBytes;
    String XHTTPDownloadScMaxEachPostBytes;
    String XHTTPDownloadScMaxBufferedPosts;
    String XHTTPDownloadScMinPostsIntervalMs;
