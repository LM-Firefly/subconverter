...
struct Proxy
{
    ...
    String ServerName;
    String SNI;
    String NameCertVerify;
    tribool AlwaysUseConnect;
    String CustomHeaders;
    int MaxStreams = 0;
    String Fingerprint;
    String TLSPubkeySha256;
    ...
    String XHTTPDownloadNameCertVerify;
    ...
    String ObfsNameCertVerify;
    String ObfsVersionHint;
    String ObfsRestlsScript;
    tribool ObfsForceTls12;
    String ObfsUsername;
    ...
    tribool PreferIPv6;
    String AmneziaContentPaddingAddition;
    String AmneziaH1;
    String AmneziaH2;
    String AmneziaH3;
    String AmneziaH4;
    String AmneziaHeaderProtectionKey;
    String AmneziaI1;
    String AmneziaI2;
    String AmneziaI3;
    String AmneziaI4;
    ...
    String AmneziaJMax;
    String AmneziaJMin;
    String AmneziaKeepaliveTimeout;
    String AmneziaMaxHandshakeAttempts;
    String AmneziaRejectAfterTime;
    String AmneziaRekeyAfterTime;
    String AmneziaRekeyTimeout;
    String AmneziaS1;
    String AmneziaS2;
    String AmneziaS3;
    String AmneziaS4;
    String AmneziaVersion;
    tribool AmneziaRandomTrailers;
    tribool AmneziaDisableCookies;
    int TestTimeout = 0;
    int Workers = 0;
    int RefreshServerIPInterval = 0;

    // OpenVPN-specific
    String OpenVPNDev;
    StringArray OpenVPNDataCiphers;
    String OpenVPNDataCipherFallback;
    String OpenVPNTLSCrypt;
    String OpenVPNTLSCryptV2;
    String OpenVPNTLSAuth;
    String OpenVPNKeyDirection;
    String CompLZO;
    uint32_t OpenVPNPing = 0;
    uint32_t OpenVPNPingRestart = 0;
    uint32_t OpenVPNHandshakeTimeout = 0;
    int32_t OpenVPNTranWindow = -1;
    StringMap OpenVPNPeerInfo;
    String IPStackMode;
    String IPStackCongestionController;
    ...
    StringArray SSHHostKey;
    StringArray SSHHostKeyAlgorithms;

    // ZeroTier-specific
    String ZeroTierNetwork;
    String ZeroTierStateDir;
    String ZeroTierIdentitySecret;
    String ZeroTierPlanet;
    int ZeroTierPhysicalMTU = 0;
    tribool ZeroTierLowBandwidth;
    tribool ZeroTierEncryptedHello;
    int ZeroTierPrimaryPort = 0;
    int ZeroTierSecondaryPort = 0;
    String ZeroTierTCPFallbackMode;
    String ZeroTierTCPFallbackRelay;
    StringArray ZeroTierOrbit;
    String ZeroTierRemoteTraceTarget;
    uint64_t ZeroTierRemoteTraceLevel = 0;
    ...
    tribool Reuse;
    tribool AnyTLSBlockQUIC;
    tribool DisableReuse;
    ...
    // ShadowQuic-specific
    StringArray QUICVersions;
    tribool ZeroRTT;
    int32_t KeepAliveInterval = 0;
...
#define ZEROTIER_DEFAULT_GROUP "ZeroTierProvider"
#define SHADOWQUIC_DEFAULT_GROUP "ShadowQuicProvider"
