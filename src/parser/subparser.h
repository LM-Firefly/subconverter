...
void vlessConstruct(
    ...
    const std::string &pkd,
    const std::string &sid,
    const std::string &fp,
    const std::string &sni,
    const std::vector<std::string> &alpnList,
    const std::string &packet_encoding, tribool udp = tribool(), tribool tfo = tribool(), tribool scv = tribool(), tribool tls13 = tribool());
...
void tuicConstruct(
    ...
    const std::string &udpRelayMode,
    const std::string &token, tribool udp = tribool(), tribool tfo = tribool(), tribool scv = tribool(), tribool reduceRtt = tribool(), tribool disableSni = tribool(), uint16_t request_timeout = 15000);
