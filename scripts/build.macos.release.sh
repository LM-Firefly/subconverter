...
c++ -Xlinker -unexported_symbol -Xlinker "*" -o base/subconverter -framework CoreFoundation -framework Security $(find CMakeFiles/subconverter.dir/src/ -name "*.o") "$(brew --prefix zlib)/lib/libz.a" "$(brew --prefix pcre2)/lib/libpcre2-8.a" $(find . -name "*.a") -L"$(brew --prefix)/lib" -L"$(brew --prefix openssl@3)/lib" -lyaml-cpp -lcurl -lssl -lcrypto -O3
